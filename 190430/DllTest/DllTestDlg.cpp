...
BEGIN_MESSAGE_MAP(CDllTestDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON_GETPATH, &CDllTestDlg::OnBnClickedButtonGetpath)
END_MESSAGE_MAP()
...
void CDllTestDlg::OnBnClickedButtonGetpath()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	CString strPath = _T("");
	if (GetModulePath(strPath))
	{
		AfxMessageBox(_T("MODULE 경로 = ") + strPath);
	}
}
