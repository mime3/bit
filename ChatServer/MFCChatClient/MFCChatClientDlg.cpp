...
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Text(pDX, IDC_EDIT_CHAT, chat);
	DDV_MaxChars(pDX, chat, 30);
...
BEGIN_MESSAGE_MAP(CMFCChatClientDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON_CHAT, &CMFCChatClientDlg::OnBnClickedButtonChat)
	ON_BN_CLICKED(IDC_BUTTON_VOTE, &CMFCChatClientDlg::OnBnClickedButtonVote)
END_MESSAGE_MAP()
...
void CMFCChatClientDlg::OnBnClickedButtonChat()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
}


void CMFCChatClientDlg::OnBnClickedButtonVote()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
}
